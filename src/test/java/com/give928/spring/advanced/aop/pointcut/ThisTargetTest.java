...
class ThisTargetTest {
    ...
    static class ThisTargetAspect {
        // 부모 타입 허용
        @Around("this(com.give928.spring.advanced.aop.member.MemberService)")
        ...
        // 부모 타입 허용
        @Around("target(com.give928.spring.advanced.aop.member.MemberService)")
        ...
        @Around("this(com.give928.spring.advanced.aop.member.MemberServiceImpl)")
        ...
        @Around("target(com.give928.spring.advanced.aop.member.MemberServiceImpl)")
